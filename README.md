...
- **Асинхронная обработка:** Apache Kafka
  - Обеспечение согласованности данных с использованием паттерна Transactional Outbox
  - Гарантия идемпотентности обработки событий на стороне consumer (хранение и проверка обработанных event key)
